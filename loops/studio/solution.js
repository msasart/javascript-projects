...
function askForNumber() {
  ...
  while (numMeals < 1 || numMeals > 6 || isNaN(numMeals)) {
    numMeals = input.question(`You must enter a number between 1 - 6. Please enter how many meals you would like to make:`)
  }
...
function runProgram() {
  ...
  let password1 = 'HotDog';
  let password2 = 'Sandwhich';
